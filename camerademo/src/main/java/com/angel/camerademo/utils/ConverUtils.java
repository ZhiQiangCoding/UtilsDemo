...
import static com.angel.camerademo.utils.ConsUtils.GB;
...
//            ret[j++]=hex
    ...
    public static String byte2FitSize(long byteNum) {
        ...
        } else if (byteNum < ConsUtils.KB) {
            return String.format(Locale.getDefault(), "%.3fB", (double) byteNum);
        } else if (byteNum < ConsUtils.MB) {
            return String.format(Locale.getDefault(), "%.3fKB", (double) byteNum / ConsUtils.KB);
        } else if (byteNum < GB) {
            return String.format(Locale.getDefault(), "%.3MB", (double) byteNum / ConsUtils.MB);
        } else {
